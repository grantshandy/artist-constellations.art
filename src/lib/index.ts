...
graphType.subscribe((value: GraphType) =>
...
nodeStyle.subscribe((value: NodeStyle) =>
  localStorage.setItem("nodeStyle", value)
);
...
export const loading: writable<{ text: string; percentage: number } | null> = writable(
  null,
);
